...
class Board(object):
    ...
    def set_heuristic(self, heur="zero"):
        if heur == "zero":
            Board.heuristic = Board.zero_heuristic
        elif heur == "blockingcars":
            Board.heuristic = Board.blockingcarsheuristic

    def blockingcarsheuristic(self):
        red_car = [
